...
ADAPTED FROM https://github.com/raspberrypi/picamera2/blob/main/examples/capture_stream.py#L8
"""
import socket
import time
...
# Create a Picamera2 object and configure it with JpegEncoder
picam2 = Picamera2()
